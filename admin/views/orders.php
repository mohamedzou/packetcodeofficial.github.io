...
<table class="table">
    ...
    <tbody>
         <?php foreach( $apicount as $apicoun ): ?>
         <tr>
             <td><?php echo $apicoun["id"] ?></td>
             <td><?php echo $apicoun["api_name"] ?></td>
             <td><?php echo $apicoun["api_charge"] ?></td>
         </tr>
         <?php endforeach; ?>
    </tbody>
</table>
                 ...
                 <td class="service-block__action">
                   <div class="dropdown pull-right">
                     ...
                     <ul class="dropdown-menu">
                       ...
                       <?php endif; ?>
                       <li><a href="<?=site_url("admin/orders/order_refill/")?>">Refill Order</a></li>
                       <?php if( $order["order_error"] == "-" && $order["service_api"] != 0 ): ?>
