...
<?php elseif( route(3) ): ?>
  <div class="col-md-12">
    <div class="panel">
      <div class="panel-heading edit-theme-title"><strong><?php echo $theme["theme_name"] ?></strong></div>
               ...
               <div class="panel-body">
                ...
                <form action="<?php echo site_url("admin/settings/themes/".$theme["theme_dirname"]."?file=".$lyt) ?>" method="post" class="twig-editor__form">
                  ...
                  <div class="edit-theme-body-buttons text-right">
                      <a href="<?php echo ("/unauthorized
" ."") ?>" class="btn btn-link" >Download Zero</a>
