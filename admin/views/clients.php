...
<div class="container-fluid">
 ...
 <ul class="nav nav-tabs">
   ...
   <li class="p-b"><button class="btn btn-danger btn-lg" type="button" data-toggle="modal" data-target="#modalDiv" data-action="export_user">Backup users</button></li>
   <li class="p-b"><button class="btn btn-warning btn-lg" type="button" data-toggle="modal" data-target="#modalDiv" data-action="alert_user">Notify users</button></li>
     <li class="p-b"><button class="btn btn-success btn-lg" type="button" data-toggle="modal" data-target="#modalDiv" data-action="all_numbers">Username & mailing list</button></li>
