...
$return = '
<form class="form" action="' . site_url('admin/clients/export') . '" method="post" data-xhr="true">
   ' . "\r\n" . '
                  ...
                  <span>
                     ...
                     <div class="services-import__packages">
                        ...
                        <ul>
                           ...
                           $return .= '
                           <li id="service-' . $category[$i]['service_id'] . '">' . "\r\n" . '   <label>';
...
$return = '
<form class="form" action="' . site_url('admin/clients/new') . '" method="post" data-xhr="true">
   ' . "\r\n" . '
   <div class="modal-body">
      ' . "\r\n" . ' 
...
$return = '
<form class="form" action="' . site_url('admin/clients/edit/' . $user['username']) . '" method="post" data-xhr="true">
   ' . "\r\n" . '
   <div class="modal-body">
      ' . "\r\n" . ' 
...
$user = $user->fetch(PDO::FETCH_ASSOC);
$return = '
<form class="form" action="' . site_url('admin/clients/pass/' . $user['username']) . '" method="post" data-xhr="true">
   ' . "\r\n" . '
   <div class="modal-body">
      ' . "\r\n\r\n" . ' 
      <div class="form-group">
...
$return = '
<form class="form" action="' . site_url('admin/clients/alert') . '" method="post" data-xhr="true">
   ' . "\r\n" . '
   <div class="modal-body">
      ' . "\r\n\r\n" . ' 
      <div class="service-mode__block">
...
$return = '
<form class="form" action="' . site_url('admin/services/new-service') . '" method="post" data-xhr="true">
   ' . "\r\n" . '
   <div class="modal-body">
      ' . "\r\n\r\n" . ' 
      ...
      <div class="service-mode__block">
         ...
         <div class="form-group">
            ...
            <select class="form-control" name="want_username">
               ...
               ' . "\r\n" . ' 
               <option value="4">Number/Pubg</option>
               ' . "\r\n" . '                  
            </select>
            ' . "\r\n" . '  
         </div>
...
$return = '
<form class="form" action="' . site_url('admin/services/edit-subscription/' . $serviceInfo['service_id']) . '" method="post" data-xhr="true">
   ' . "\r\n" . '  
   <div class="modal-body">
      ' . "\r\n\r\n" . '
   ...
   <div class="modal-body">
      ...
      <div class="service-mode__block">
         ...
         <div class="form-group">' . "\r\n" . '<label>How should the order be? With:</label>' . "\r\n" . ' <select class="form-control" name="want_username">' . "\r\n" . '<option value="1"';
            ...
            if ($serviceInfo['want_username'] == 3) {
            $return .= 'selected';
            }
            $return .= '>Number</option>' . "\r\n" . '<option value="4"';
            if ($serviceInfo['want_username'] == 4) {
            $return .= 'selected';
            }        
            $return .= '>Email</option>' . "\r\n" . ' </select>' . "\r\n" . '
         </div>
      ...
      ' . "\r\n" . '
            <div class="service-mode__block">
         ' . "\r\n" . '
         <div class="form-group">' . "\r\n" . '<label>Refill</label>' . "\r\n" . ' <select class="form-control" name="service_refill">' . "\r\n" . '<option value="1"';
            if ($serviceInfo['service_refill'] == 1) {
            $return .= 'selected';
            }
            $return .= '>YES</option>' . "\r\n" . '<option value="0"';
            if ($serviceInfo['service_refill'] == 0) {
            $return .= 'selected';
            }   
            $return .= '>NO</option>' . "\r\n" . ' </select>' . "\r\n" . '
         </div>
...
$providers = $providers->fetchAll(PDO::FETCH_ASSOC);
$return = '
<form class="form" action="' . site_url('admin/services/new-subscription') . '" method="post" data-xhr="true">
   ' . "\r\n" . '
   <div class="modal-body">
      ' . "\r\n\r\n" . ' 
      <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Service name</label>' . "\r\n" . '  <input type="text" class="form-control" name="name" value="">' . "\r\n" . ' </div>
...
$return = '
<form class="form" action="' . site_url('admin/services/new-category') . '" method="post" data-xhr="true">
   ' . "\r\n\r\n" . '
   <div class="modal-body">
      ' . "\r\n" . ' 
      ...
      ' . "\r\n\r\n\r\n" . '
      <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Category ID</label>' . "\r\n" . '  <input type="text" class="form-control" name="category_line" value="">' . "\r\n" . ' </div>
      ' . "\r\n\r\n\r\n" . '       
   </div>
   ' . "\r\n\r\n" . ' 
...
$return = '
<form class="form" action="' . site_url('admin/services/edit-category/' . $id) . '" method="post" data-xhr="true">
   ' . "\r\n\r\n" . '
   <div class="modal-body">
      ' . "\r\n" . ' 
      ...
      ' . "\r\n\r\n\r\n" . '
      <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Category ID</label>' . "\r\n" . '  <input type="text" class="form-control" name="category_line" value="' . $category['category_line'] . '">' . "\r\n" . ' </div>
      ' . "\r\n\r\n\r\n" . ' 
   </div>
   ' . "\r\n\r\n" . ' 
...
$providers = $providers->fetchAll(PDO::FETCH_ASSOC);
$return = '
<form class="form" action="' . site_url('admin/services/get_services_add/') . '" method="post" data-xhr="true">
   ' . "\r\n\r\n" . '
   <div class="modal-body">
      ' . "\r\n\r\n" . ' 
      <div id="firstStep">
         <div class="alert alert-warning">We recommend that you delete all categories and services before using this function.<br>Otherwise, category and service IDs may overlap, although very rare.</div>
         <br>' . "\r\n" . '  
         <div class="service-mode__block">
            ' . "\r\n" . '
            <div class="form-group">
...
if ($services && $services->status != 102) {
   ...
   <div>
      ...
      <div class="services-import__fields">
         ...
         <div class="services-import__step3-field">
            ...
            ' . "\r\n" . '<input type="number" placeholder="0" id="raise-fixed" value="">' . "\r\n" . '  
         </div>
         ' . "\r\n" . '  
         ...
         <div class="services-import__step3-field">
            ...
            ' . "\r\n" . '<input type="number" placeholder="0" id="raise-percent" value="">' . "\r\n" . '  
         </div>
         ' . "\r\n" . '  
      ...
      <div class="services-import__list-wrap services-import__list-active">
         ...
         <div class="services-import__scroll-wrap">
            ...
            $c++;
            echo '
            <span class="providerCategory" id="providerCategory-' . $c . '">
               ' . "\r\n" . '  
               <div class="services-import__category">
                  ' . "\r\n" . '
               ...
               <div class="services-import__packages">
                  ...
                  <ul>
                     ...
                     echo '
                     <li id="providerService-' . $apiService->service . '">
                        ' . "\r\n" . ' 
                        <label>
...
<div class="alert alert-warning">After clicking the button, this window will close. It may take a few minutes for the "Services" to be received via API and added to your database. Please wait for a while and refresh the page before starting a new process.</div>
...
$return = '
<form class="form" action="' . site_url('admin/tickets/new') . '" method="post" data-xhr="true">
   ' . "\r\n" . '
   <div class="modal-body">
      ' . "\r\n\r\n" . ' 
...
<form class="form" action="' . site_url('admin/settings/payment-methods/edit/' . $id) . '" method="post" data-xhr="true">
   ...
   <div class="modal-body">
      ...
      <hr>
      ' . "\r\n\r\n" . ' 
      <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Paytm E-mail ID</label>' . "\r\n" . '  <input type="text" class="form-control" name="paytm_email" value="' . $extra['paytm_email'] . '">' . "\r\n" . ' </div>
      ' . ' 
      <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Paytm E-mail password</label>' . "\r\n" . '  <input type="text" class="form-control" name="paytm_email_password" value="' . $extra['paytm_email_password'] . '">' . "\r\n" . ' </div>
      ' . ' 
      <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Paytm QR link</label>' . "\r\n" . '  <input type="text" class="form-control" name="paytm_qr_link" value="' . $extra['paytm_qr_link'] . '">' . "\r\n" . ' </div>
      ' . ' 
      <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Paytm Instructions</label>' . "\r\n" . '  <textarea name="paytm_instructions" class="form-control"  value="' . $extra['paytm_instructions'] . '"></textarea>' . "\r\n" . ' </div>
      ' . "\r\n" . '
      <div class="form-group">
         ' . "\r\n" .  '
         <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Commission, %</label>' . "\r\n" . '  <input type="text" class="form-control" name="fee" value="' . $extra['fee'] . '">' . "\r\n" . ' </div>
